...
},{"./svg":"../src/svg.js","_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.common.js"}],"tabComponent.test.js":[function(require,module,exports) {
"use strict";
...
describe('tab组件测试', function () {
  it('Tabs存在.', function () {
    expect(_tabs.default).to.be.ok;
  });
  it('TabsBody存在.', function () {
    expect(_tabsBody.default).to.be.ok;
  });
  it('TabsHead存在.', function () {
    expect(_tabsHead.default).to.be.ok;
  });
  it('TabsItem存在.', function () {
    expect(_tabsItem.default).to.be.ok;
  });
  it('TabsPane存在.', function () {
    expect(_tabsPane.default).to.be.ok;
  });
  ...
  it('验证tab组件传值，item/body组件的展示', function () {
    ...
    vm.$nextTick(function () {
      var activeDiv = vm.$el.querySelector('.active');
      var activePane = vm.$el.querySelector('.tabs-pane');
  ...
  it('disabled参数 item/body组件的展示', function () {
    ...
    vm.$nextTick(function () {
      var itemsDivs = vm.$el.querySelectorAll('.tabs-item');
...
},{"vue":"../node_modules/vue/dist/vue.common.js","../src/tabs":"../src/tabs.vue","../src/tabs-body":"../src/tabs-body.vue","../src/tabs-head":"../src/tabs-head.vue","../src/tabs-item":"../src/tabs-item.vue","../src/tabs-pane":"../src/tabs-pane.vue","../src/icon":"../src/icon.vue"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","tabComponent.test.js"], null)
//# sourceMappingURL=/tabComponent.test.js.map