...
describe('Input', function () {
  ...
  describe('测试prop', function () {
    ...
    it('接收 error', function () {
      ...
      var inputElement = vm.$el.querySelector('.icon-error>use');
      var inputElementMessage = vm.$el.querySelector('.error-message');
  ...
  describe('事件', function () {
    ...
    it('支持 change等 事件', function () {
      ['change', 'input', 'blur', 'focus'].forEach(function (value, index) {
