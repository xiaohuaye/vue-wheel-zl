...
describe('Toast', function () {
  it('存在.', function () {
    expect(_toast.default).to.be.exist;
  });
  describe('测试prop', function () {
    ...
    it('closeButton', function (done) {
      ...
      var closeBtn = vm.$el.querySelector('.closeToast');
    ...
    it('enableHtml', function () {
      ...
      vm.$slots.default = ["<span id=\"test".concat(randomNum, "\"></span>")];
      vm.$mount();
      expect(vm.$el.querySelector("#test".concat(randomNum))).to.be.exist;
    });
