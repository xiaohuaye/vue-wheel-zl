...
},{"./icon":"../src/icon.vue","_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.common.js"}],"popover.test.js":[function(require,module,exports) {
"use strict";
...
var _button2 = _interopRequireDefault(require("../src/button"));
...
describe('popover组件测试', function () {
  it('popover存在.', function () {
    expect(_popover.default).to.be.exist;
  });
  ...
  it('测试点击出现popover内容', function () {
    ...
    var button = vm.$el.querySelector('.g-button');
    var popoverCom = document.body.querySelector('.popover-content');
    expect(popoverCom).to.be.not.exist;
    button.click();
    vm.$nextTick(function () {
      var popoverCom = document.body.querySelectorAll('.popover-content');
      popoverCom = Array.prototype.slice.call(popoverCom);
      var isHasThisPop = popoverCom.some(function (node) {
  ...
  it('测试点击出现popover内容的方向', function () {
    var div = document.createElement('div');
    document.body.appendChild(div);
    ...
    vm.$nextTick(function () {
      var popoverCom = document.body.querySelectorAll('.popover-content');
      popoverCom = Array.prototype.slice.call(popoverCom);
      var popoverCom1 = null;
      popoverCom.map(function (node) {
  ...
  it('测试hover出现popover内容', function () {
    var div = document.createElement('div');
    document.body.appendChild(div);
    ...
    var touch = vm.$el.querySelector('.popTouch');
    var event = new Event('mouseenter');
    touch.dispatchEvent(event);
    vm.$nextTick(function () {
      var popoverCom = document.body.querySelectorAll('.popover-content');
      popoverCom = Array.prototype.slice.call(popoverCom);
      var popoverCom2 = popoverCom.some(function (node) {
  ...
  xit('测试点击出现popover内容，内部有关闭按钮可关闭', function () {
    var div = document.createElement('div');
    ...
    vm.$nextTick(function () {
      ...
      popoverCom.map(function (node) {
        if (node.querySelector('.testButton')) {
          var _button = node.querySelector('.testButton');
...
},{"vue":"../node_modules/vue/dist/vue.common.js","../src/popover":"../src/popover.vue","../src/button":"../src/button.vue"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
